...
class Model: 
	...
	def setupCTC(self):
		...
		if self.decoderType == DecoderType.BestPath:
			...
			wordChars = open('C:/Users/Rocky lappy/Desktop/SimpleHTR-master/model/wordCharList.txt').read().splitlines()[0]
			corpus = open('C:/Users/Rocky lappy/Desktop/SimpleHTR-master/data/corpus.txt').read()
	...
	def setupTF(self):
		...
		modelDir = 'C:/Users/Rocky lappy/Desktop/SimpleHTR-master/model/model'
	...
	def save(self):
		"save model to file"
		self.snapID += 1
		self.saver.save(self.sess, 'C:/Users/Rocky lappy/Desktop/SimpleHTR-master/model/snapshot', global_step=self.snapID)
